...
Podemos usar la función map para calcular distintos modelos modelos. Por ejemplo, calculemos un modelo distinto según el perfil (DA y DS). En este caso pasamos como función un modelo lineal simple:
...
Si bien la salida es bastante útil, la información sobre cuál modelo estamos observamos forma parte de la salida. Con la función `map_dfr` podemos concatenar los dataframes de salida y con el argumento **.id** crear una columna para indicar el modelo:
