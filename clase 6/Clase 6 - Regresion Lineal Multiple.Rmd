...
modelo_st_r <- lm(price ~ surface_covered + rooms, data = train_data)
# Resumen del modelo
...
modelo_st_pt <- lm(price ~ surface_covered + property_type, data = train_data)
...
```{r}
# ajustamos el modelo
modelo_st_l3 <- lm(price ~ surface_covered + l3, data = train_data)
