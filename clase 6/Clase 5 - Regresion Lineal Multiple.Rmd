...
### Analizamos las demás variables no numéricas. 

Existen 57 barrios de capital federal (variable l3). En los boxplots paralelos de precios por barrios se puede ver que entre los barrios que presentan mayores precios se ubican: Puerto Madero, Catalinas, Las Cañitas, Recoleta y Belgrano, mientras que Constitución, la Boca y Villa Soldati presentan los menores precios de propiedades. 
...
ggplot(datos_properati, aes(y = precio_en_miles, group = property_type, fill = property_type )) +
  geom_boxplot() +
...
Armemos un modelo para predecir el precio en función de los años de experiencia y la gente_a_cargo. Veamos los resultados del modelo empleando la función tidy(). 
