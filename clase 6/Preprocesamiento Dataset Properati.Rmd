...
Se van a hacer los análisis para outliers univariados teniendo en cuenta que según los gráficos anteriores parecen existir valores atipicos para la superficie y la cantidad de cuartos. También reconsideraría ese filtro manual de las primeras observaciones ya que debería estar capturado/filtrado por el siguiente criterio
...
```
En particular, se detectó la presencia de un regitro atípico correspondiente a un PH de 126000 metros de superficie por 215 mil dolares y de un registro de un numero de ambientes de 32, también correspondiente a un PH en San Telmo. 
