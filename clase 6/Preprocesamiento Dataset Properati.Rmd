...
datos <- read_csv("ar_properties.csv")
glimpse(datos)
```
...
* Los **mínimos** parecen bajos, en el caso del departamento figura uno de 6 mil dolares, pero habría que ver la relación precio por metro cuadrado para ver si se trata de un valor atípico, un error o simplemente de un terreno pequeño. En contraste, las propiedades más caras se presentan en barrios de precios más caros.  
...
```
En particular, se detectó la presencia de un regitro atípico correspondiente a un PH de 126000 metros de superficie por 215 mil dolares y de un registro de un numero de ambientes de 32, también correspondiente a un PH en San Telmo. Se decidió eliminar dichos registros por considerarse outliers.
...
Para detectar presencia de outliers, además de analizar los scatterplot y eliminar registros específicos, se definió crear una variable de precio por metro cuadrado ya que, de proceder sólo empleando los precios, se correría el riesgo de eliminar propiedades de precios altos que en realidad corresponden a superficies más amplias y no serían valores atípicos. Por lo que, detectar outliers en base a esta nueva variable es una forma de evitar incurrir en errores de ese estilo.  
...
* Se optó por adicionar un criterio de valor de corte porque la técnica de desvíos del RI resulta insufiente para detectar outliers a izquierda en una distribución asimétrica a derecha. 
